            ...
            <div class="header-body">
                <div class="row align-items-center py-6">
                    <div class="col-lg-6 col-7">
                        ...
                        @endif
                        <h6 class="h2 text-white d-inline-block mb-0">Tambah Kelas</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('/admin/kelas') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                <a href="{{ url('/admin/kelas') }}" class="btn btn-danger"><i
