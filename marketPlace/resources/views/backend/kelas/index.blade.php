            ...
            <div class="header-body">
                ...
                <div class="row align-items-center py-1">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ url('admin/kelas/create') }}" class="btn btn-neutral fas fa-plus">&nbsp Tambah Data</a>
                            ...
                            <tbody>
                                @foreach ($Kelas as $kelas)
                                    <tr>
                                        ...
                                        <td>@currency($kelas->nominal) </td>
                                        <td>{!! Str::limit($kelas->desktripsi, 25) !!}</td>
                                        <td>
                                            <a href="/admin/kelas/{{ $kelas->id }}" class="badge badge-light-secondary">
                                                <i class="fas fa-solid fa-eye"></i>
                                                Lihat
                                            </a>
                                            <a href="{{ url('/admin/kelas/' . $kelas->id) }}/edit"
