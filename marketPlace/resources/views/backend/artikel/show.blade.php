            ...
            <div class="header-body">
                <div class="row align-items-center py-6">
                    <div class="col-lg-6 col-7">
                        ...
                        @endif
                        <h6 class="h2 text-white d-inline-block mb-0">Detail Artikel</h6>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" placeholder="Ex. ( SMA )" class="form-control"
                                value="{{ $Artikel->judul }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Deskripsi <span class="text-primary">*</span></label>
                            <textarea type="text" name="deskripsi" readonly id="task-textarea" class="form-control">{{ $Artikel->deskripsi }}</textarea>
                        </div>
                        <div class="card-body">
                            <form action="{{ url('/admin/artikel/' . $Artikel->id) }}" method="POST">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a href="{{ url('/admin/artikel/') }}" class="btn btn-warning" type="submit"><i
                                            class="fas fa-backward"></i>&nbsp Kembali</a>
                                    <a href="{{ url('/admin/artikel/' . $Artikel->id) }}/edit" class="btn btn-primary"
