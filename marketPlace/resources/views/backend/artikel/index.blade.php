            ...
            <div class="header-body">
                ...
                <div class="row align-items-center py-1">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ url('admin/artikel/create') }}" class="btn btn-neutral fas fa-plus">&nbsp Tambah Data</a>
                            ...
                            <tbody>
                                @foreach ($Artikel as $artikel)
                                    <tr>
                                        ...
                                        <td>{{ $artikel->judul }}</td>
                                        <td>{!! Str::limit($artikel->deskripsi, 25) !!}</td>
                                        <td>
                                            <a href="/admin/artikel/{{ $artikel->id }}"
