            ...
            <div class="header-body">
                <div class="row align-items-center py-6">
                    <div class="col-lg-6 col-7">
                        ...
                        @endif
                        <h6 class="h2 text-white d-inline-block mb-0">Detail Kategori Artikel</h6>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">                        
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_kategori" placeholder="" class="form-control"
                                value="{{ $Category->nama_kategori }}" readonly>
                        </div>
                        <div class="card-body">
                            <form action="{{ url('/admin/category/' . $Category->id) }}" method="POST">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a href="{{ url('/admin/category/') }}" class="btn btn-warning" type="submit"><i
                                            class="fas fa-backward"></i>&nbsp Kembali</a>
                                    <a href="{{ url('/admin/category/' . $Category->id) }}/edit" class="btn btn-primary"
